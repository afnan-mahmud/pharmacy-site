...
export const pageTitle = "font-display text-lg font-extrabold text-ink";

export const label = "text-sm font-medium text-ink";

export const input =
  "w-full rounded-xl border border-line bg-surface px-3.5 py-2.5 text-sm text-ink placeholder:text-muted focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20";

export const btnPrimary =
  "rounded-full bg-brand px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-strong disabled:opacity-60";
