...
export function RetailLedger({ phone, customerName, duePaisa, ledger, onClose }: Props) {
  ...
  const td = tdCls;
  const displayName = customerName || "(নাম নেই)";
  const firstChar = (customerName || "C").trim().charAt(0).toUpperCase();

  return (
    <div className="space-y-4 pb-8">
      {/* Top Navigation & Customer Summary Card */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-display text-lg sm:text-xl font-black text-ink">{displayName}</h1>
